...
public class Form_Menu_Petugas extends javax.swing.JFrame {
    ...
    public Form_Menu_Petugas(String nama_petugas1) {
        initComponents();
    ...
    private void initComponents() {
        ...
        cbx_komp_keahlian.setLightWeightPopupEnabled(false);
        cbx_komp_keahlian.setLineColor(new java.awt.Color(255, 255, 255));
    ...
    public void search_data_kelas() {
        ...
        try {
            ...
            Notification panel = new Notification(this, Notification.Type.WARNING, Notification.Location.CENTER_RIGHT, "Ada Kesalahan Di Search Data " + e);
            panel.showNotification();
        }
    }
    ...
    private void table_mouse_klik_kelas() {
        try {
            ...
            java.sql.ResultSet sql = stm.executeQuery("select * from tb_kelas where id_kelas='" + table_klik + "'");
            if (sql.next()) {
            ...
            Notification panel = new Notification(this, Notification.Type.WARNING, Notification.Location.CENTER_RIGHT, "Ada Kesalahan Di Table Mouse Click " + e);
            panel.showNotification();
        }
    }
